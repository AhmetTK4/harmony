          ...
          <div className="bg-white shadow rounded-lg p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-indigo-50 p-4 rounded-lg">
                <h3 className="text-lg font-medium text-indigo-900">User Service</h3>
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                ...
                <p className="text-green-700 mt-2">JWT Active</p>
              </div>
              <div className="bg-blue-50 p-4 rounded-lg">
                <h3 className="text-lg font-medium text-blue-900">Database</h3>
                <p className="text-blue-700 mt-2">MongoDB Connected</p>
              </div>
            </div>
          </div>
        ) : (
